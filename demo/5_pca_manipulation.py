...
def get_pca_color(feat, brightness=1.25, center=True):
    # Logic from Input 1
    u, s, v = torch.pca_lowrank(feat, center=center, niter=5, q=6)
    projection = feat @ v
...
if __name__ == "__main__":
    ...
    transform = utonia.transform.default(4.0)

    point = utonia.data.load("sample4_manipulation")
